...
Les commandes de migration disponibles couvrent tous les trajets possibles entre ces backends :
...
Si vous souhaitez quitter le stockage en base et revenir au système de fichiers :
...
- **Trafic** : Chaque fichier devant être servi par Django, il est déconseillé de l'utiliser sur les sites à fort trafic.
