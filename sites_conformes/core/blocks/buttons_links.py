...
from sites_conformes.core.validators import validate_query_string
...
class AnchorBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "anchor"
        template = "sites_conformes_core/blocks/anchor.html"
...
class LinkWithoutLabelBlock(blocks.StructBlock):
    ...
    def clean(self, value):
        ...
        if not selected_link_type:
            # This is for backward compatibility: try to infer the link type
            for link_type in self.link_types:
                if value.get(link_type):
                    selected_link_type = link_type
                    value["link_type"] = link_type
                    break
        elif selected_link_type:
...
class LinksVerticalListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "sites_conformes_core/blocks/links_vertical_list.html"
...
class ButtonsHorizontalListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "sites_conformes_core/blocks/buttons_horizontal_list.html"
...
class ButtonsVerticalListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "sites_conformes_core/blocks/buttons_vertical_list.html"
...
class ButtonsListBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "sites_conformes_core/blocks/buttons_list.html"
...
class SingleLinkBlock(LinkBlock):
    ...
    class Meta:
        value_class = LinkStructValue
        icon = "link"
        template = "sites_conformes_core/blocks/link.html"
