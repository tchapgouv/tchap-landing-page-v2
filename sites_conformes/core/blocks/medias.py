...
class ImageBlockWithDefault(ImageBlock):
    ...
    def get_default(self):
        if self._default_image_title:
            ...
            if image:
                # ImageBlock represents its value as an Image instance with
...
class IframeBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "globe"
        template = "sites_conformes_core/blocks/iframe.html"
...
class TranscriptionBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "media"
        template = "sites_conformes_core/blocks/transcription.html"
...
class VideoBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "media"
        template = "sites_conformes_core/blocks/video.html"
